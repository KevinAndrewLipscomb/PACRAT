...
<html>
  <head runat="server">
    <title></title>
    <!-- $Id: hardcopy_state_strike_team_key_personnel.aspx 7189 2020-05-25 01:22:15Z kevinanlipscomb $ -->
  ...
  <body bgcolor="white">
    <form runat="server">
      ...
      <br />
      <uc1:UserControl_static_state_strike_team_key_personnel ID="UserControl_static_state_strike_team_key_personnel_control" runat="server" />
    </form>
