...
<%@ Page language="c#" codebehind="region_management.aspx.cs" AutoEventWireup="True" Inherits="region_management.TWebForm_region_management" %>
...
<html>
  <head runat="server">
    <title></title>
    <!-- $Id: region_management.aspx 7204 2020-05-31 19:25:18Z kevinanlipscomb $ -->
                          ...
                          <td>
                            <table cellpadding="5" cellspacing="0" width="100%">
                              ...
                              <tr>
                                ...
                                <td>
                                  <asp:CheckBox ID="CheckBox_be_pacrat_subscriber" runat="server" AutoPostBack="True" oncheckedchanged="CheckBox_be_pacrat_subscriber_CheckedChanged" Enabled="False" />
                                </td>
                              </tr>
                            </table>
                          </td>
