...
<%@ Page language="c#" codebehind="opfar.aspx.cs" AutoEventWireup="True" Inherits="opfar.TWebForm_opfar" EnableViewState="False" %>
<%@ Register TagPrefix="uc1" TagName="UserControl_common_header_bar" Src="~/usercontrol/app/UserControl_common_header_bar.ascx" %>
<%@ Register TagPrefix="uc2" TagName="UserControl_opfar" Src="~/usercontrol/app/UserControl_opfar.ascx" %>
<html>
  <head runat="server">
    <title></title>
    <!-- $Id: opfar.aspx 7189 2020-05-25 01:22:15Z kevinanlipscomb $ -->
